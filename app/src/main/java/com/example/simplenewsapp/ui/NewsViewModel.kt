...
import com.example.simplenewsapp.NewsApplication
import com.example.simplenewsapp.models.Article
import com.example.simplenewsapp.models.NewsResponse
    ...
    private suspend fun safeSearchNewsCall(searchQuery: String) {
        ...
        try {
            ...
            when (t) {
                ...
                else -> searchNews.postValue(Resource.Error("Conversion Error")) //for conversion from json to kotlin object fail
            }
        }
    }
    ...
    private suspend fun safeBreakingNewsCall(countryCode: String) {
        ...
        try {
            ...
            when (t) {
                ...
                else -> breakingNews.postValue(Resource.Error("Conversion Error")) //for conversion from json to kotlin object fail
            }
        }
    }
